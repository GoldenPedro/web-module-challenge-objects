...
console.log(createMenuItem("Spaghetti", 15, "Lunch"));
console.log(createMenuItem("Cake", 5, "Dessert"));
...
reviews.push({name: "Pedro", rating: 5, feedback: "Great atmosphere. Wish we were given plates though."})
console.log(reviews);
